                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group @if ($errors->get('name'))
                            ...
                            <input type="text" name="name" class="form-control" id="exampleInputEmail1"
                                placeholder="Tên người dùng" value="@if(Session::get('data_post_user')['name']) {{ Session::get('data_post_user')['name'] }} @endif" required>
                            @if ($errors->get('name'))
                        ...
                        <div class="form-group @if ($errors->get('email'))
                            ...
                            <input type="email" name="email" class="form-control" id="exampleInputEmail1"
                                placeholder="Email" value="@if(Session::get('data_post_user')['email']) {{ Session::get('data_post_user')['email'] }} @endif" required>
                            @if ($errors->get('email'))
